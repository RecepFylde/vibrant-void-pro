      ...
      <div className="max-w-7xl mx-auto">
        <ScrollReveal>
          <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-12 mb-16">
            <div>
              <p className="text-primary text-sm tracking-[0.3em] uppercase font-heading mb-4">— İletişim</p>
              <h2 className="font-heading text-4xl md:text-6xl lg:text-7xl font-bold text-foreground leading-tight">
                Birlikte harika<br />
                bir şeyler <span className="text-primary">yapalım.</span>
              </h2>
            </div>
            <a
              href="mailto:hello@example.com"
              className="px-8 py-4 bg-primary text-primary-foreground font-heading font-semibold rounded-full hover:opacity-90 transition-opacity text-lg neon-glow"
            >
              İletişime Geç →
            </a>
          </div>
