  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center section-padding pt-32 noise-overlay mesh-gradient overflow-hidden">
      <div className="relative z-10 max-w-7xl mx-auto w-full">
        ...
        <ScrollReveal delay={0.1} className="absolute top-0 right-0 hidden md:block">
          <div className="relative">
            <div className="w-28 h-28 lg:w-36 lg:h-36 rounded-full overflow-hidden border-2 border-border relative">
              <img
                src={profileImg}
                alt="Profile"
